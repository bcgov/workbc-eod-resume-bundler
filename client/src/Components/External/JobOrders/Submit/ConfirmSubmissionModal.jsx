    ...
    <Modal show={show} size="xl">
        ...
        <Modal.Body>
            ...
            <h5 style={{ fontWeight: "bold" }}>
                Catchment: <a style={{ fontWeight: "normal" }}>{catchment?.name}</a>
            </h5>
            <h5 style={{ fontWeight: "bold" }}>
                WorkBC Centre: <a style={{ fontWeight: "normal" }}>{centre?.name}</a>
            </h5>
            {applicants.map((a, index) => (
                <>
                    ...
                    <h5 style={{ fontWeight: "bold" }}>
                        Client Name: <a style={{ fontWeight: "normal" }}>{a.clientName}</a>
                    </h5>
                    <h5 style={{ fontWeight: "bold" }}>
                        Client Case Number: <a style={{ fontWeight: "normal" }}>{a.clientCaseNumber}</a>
                    </h5>
                    <h5 style={{ fontWeight: "bold" }}>
                        Resume Name: <a style={{ fontWeight: "normal" }}>{a.resume?.fileName}</a>
                    </h5>
                </>
            ))}
        </Modal.Body>
