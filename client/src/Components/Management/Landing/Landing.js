                                ...
                                <div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <a href="/jobOrdersExternal" className="btn btn-lg btn-dark">View Job Orders</a><br/><br/>
                                        </div>
                                        <div className="cold-md-6">
                                            <a href="/submissionsExternal" className="btn btn-lg btn-dark">My Submissions</a><br/><br/>
                                        </div>
                                    </div>
                                    :
