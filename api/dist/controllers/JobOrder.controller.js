...
exports.createJobOrder = exports.getJobOrders = void 0;
var jobOrderService = __importStar(require("../services/JobOrder.service"));
var JobOrderValidationSchema = require('../schemas/JobOrderValidationSchema');
// Get Job Orders //
var getJobOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var jobOrders, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, jobOrderService.getJobOrders()];
            case 2:
                jobOrders = _a.sent();
                return [2 /*return*/, res.status(200).json(jobOrders)];
            case 3:
                e_1 = _a.sent();
                console.log(e_1);
...
// Create Job Order //
var createJobOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        try {
            JobOrderValidationSchema.validate(req.body, { abortEarly: false })
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, jobOrderService.createJobOrder(req.body)];
                        case 1:
                            newID = _a.sent();
